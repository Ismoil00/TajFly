...
public class AdapterLandingPlanes extends RecyclerView.Adapter<AdapterLandingPlanes.ViewHolder> {
    ...
    @Override
    public AdapterLandingPlanes.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int index) {
